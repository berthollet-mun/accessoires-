  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#121212] border border-base-border/5 rounded-3xl p-10">
        <h2 className="text-3xl font-bold tracking-tighter text-primary-text mb-2">Create Account</h2>
        <p className="text-xs text-primary-text/40 mb-8 uppercase tracking-widest font-mono">Join Luxe Essentials</p>
        
        <form onSubmit={handleRegister} className="flex flex-col gap-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-widest text-primary-text/60 mb-2">First Name</label>
              <input
                type="text"
                required
            ...
            <div>
               <label className="block text-[10px] font-bold uppercase tracking-widest text-primary-text/60 mb-2">Last Name</label>
              <input
                type="text"
                 required
                className="w-full bg-primary/5 border border-base-border/10 rounded-xl p-4 text-primary-text text-sm focus:outline-none focus:border-[#C5A059] transition-colors"
        ...
        <div className="mt-8 text-center text-[10px] font-mono tracking-widest uppercase text-primary-text/40">
          Already have an account? <Link to="/login" className="text-[#C5A059] hover:text-primary-text transition-colors border-b border-[#C5A059]/50 pb-1">Sign In</Link>
        </div>
      </div>
    </div>
  );
